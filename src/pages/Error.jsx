...
const ResourceNotAvailable = () => {
  return (
    <div className="md:pl-[70px] relative bg-richblack-900  h-screen w-full md:flex ">
      <div className=" h-screen bg-richblack-900  flex flex-col justify-center items-center md:items-start lg:w-full px-2.5 md:px-0">
        ...
        <div className="flex items-center bg-richblack-900 ">
        <Link to='/'>
          <button className="text-[#4674ff] text-[32px] font-[500px] font-poppins w-[220px]">
            Back to home
          </button>
        </Link>
          <svg
